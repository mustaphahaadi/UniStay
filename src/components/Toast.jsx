...
const Toast = ({
  ...
  const toast = (
    <div
      className={`fixed ${positionStyles[position]} z-50 transition-opacity duration-300 ${
        isVisible ? 'opacity-100' : 'opacity-0'
      }`}
    >
      <div
        className={`flex items-center p-4 mb-4 rounded-lg shadow-lg ${typeStyles[type]}`}
        role="alert"
      >
        ...
        <button
          type="button"
          className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex items-center justify-center h-8 w-8 hover:bg-gray-100 dark:hover:bg-gray-700"
          onClick={() => {
            setIsVisible(false);
